...
let somaValor  // valor total 
somaValor = 0  // valor total de vendas SEM gorjeta

receita.forEach( v  =>{
    somaValor = somaValor + v.valor
    // console.log ( `${receita.valor}`)
})

console.log (`O valor total de vendas SEM gorjeta é = ${ somaValor }`)
/* ----------------------------------------------------------------------------- */

/* PROBLEMA 2: Qual o valor total de vendas incluindo a gorjeta? --------------- */
//COLOQUE SUA SOLUÇÃO AQUI

somaValor = 0  // agora valor total de vendas INCLUINDO gorjeta

receita.forEach( v  =>{
    somaValor = somaValor + v.valor + v.gorjeta
})

console.log (`O valor total de vendas INCLUINDO a gorjeta = ${ somaValor }`)
...
const parcial50 = new Counter()

parcial50.add(receita.filter( v => v.valor < 50 ))

console.log (`A quantidade de vendas foram abaixo de 50 reais = ${ parcial50.count }`)
